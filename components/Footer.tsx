            ...
            <ul className="space-y-3">
              {siteConfig.nav.map((item) => (
                <li key={item.href}>
                  <Link
                    href={item.href}
                    className="text-base text-neutral-600 hover:text-green-800 transition-colors duration-200"
                  >
                    {item.label}
                  </Link>
                </li>
            ...
            <div className="flex flex-wrap gap-3">
              {Object.entries(siteConfig.social).map(([platform, url]) => (
                <a
                  ...
                  className="px-4 py-2 bg-white border-2 border-neutral-200 text-neutral-700 hover:border-green-800 hover:text-green-800 transition-colors duration-200 rounded-lg font-medium text-sm capitalize"
                >
                  {platform}
                </a>
              ))}
