...
function HeroValueProp() {
  return (
    <section className="w-full mb-8 lg:mb-10">
      ...
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-primary-50 via-white to-primary-50/50 p-6 sm:p-8 lg:p-10 shadow-2xl border border-primary-100">
        ...
        <div className="relative z-10">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6 mb-8">
            ...
            <Link 
              ...
              className="inline-flex items-center gap-3 px-8 py-4 bg-white text-neutral-900 font-bold rounded-xl shadow-md hover:shadow-lg hover:bg-brand-secondary/10 transition-all duration-300 border-2 border-brand-primary"
            >
